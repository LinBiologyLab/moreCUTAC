...
inputdir1=${workdir}/16.genBedGraphByStatus
stepdir=${workdir}/17.genBigWigStatus
...
bedGraphToBigWig ${inputdir1}/${statusID}.bg  ${refdir}/genome.chrom.sizes  ${stepdir}/${statusID}.bw > ${outfile} 2> ${errfile}


bedGraphToBigWig ${inputdir1}/${statusID}.norm.bg  ${refdir}/genome.chrom.sizes  ${stepdir}/${statusID}.norm.bw > ${outfile} 2> ${errfile}
